        ...
        <div class="row">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="ri-text left-side">
              <div class="section-title">
                <div class="section-title">
                  <span>wonderful Ocean view</span><br/><span> or Forest view</span>
                  <h2>Suite </h2>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
        ...
        <div class="row">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="ri-text left-side">
              <div class="section-title">
                <div class="section-title">
                  <span>a memorable holiday </span><br/><span>with My Family</span>
                  <h2>Family</h2>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
