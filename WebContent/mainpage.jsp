...
<body>
    ...
    <header class="header-section">
        <div class="container-fluid">
            <div class="inner-header">
                <div class="logo">
                    <a href="mainpage.jsp"><img src="img/logo.png" alt="ë¡ê³ ì´ë¯¸ì§"></a>
                </div>
                <nav class="nav-right">
                    <ul>
                        <li><a href="#">JP</a></li>
                        ...
                        <div class="video-section">
                            <div class="container">
                                <div class="video-text set-bg">
                                    <a href="https://www.youtube.com/watch?v=yU5LyoQEPLw" class="pop-up"><i
    ...
    <div id="inner_wrap">
        <div class="promotion">
            <H2 class="reference_title">#&nbsp;<span class="pointcolor">S</span>pecial Offers</H2>
            ...
            <div class="inner_center">
                <div id="promotion1">
                    <ul>
                        ...
                        <li><span class="currency">KRW</span>&nbsp;<span class="cost"><b>0 ~</b></span></li>
                ...
                <div id="promotion2">
                    <ul>
                        ...
                        <li class="package"># PACKAGE</li>
                        <li>ESPECIALìì ìëíê³  ì¾ì í ë¦¬íë ì íë§íì</li>
                        <li>ìì½ : 2020-09-01 ~ 2020-12-31</li>
                        <li><span class="currency">KRW</span>&nbsp;<span class="cost"><b>336,000 ~</b></span></li>
                        <li><a href="#" class="promotion_more">more</a></li>
                    </ul>
                </div>
                ...
                <div id="promotion3" style="margin-left: 0;">
                    <ul>
                        ...
                        <li class="package"># PACKAGE</li>
                        <li>ESPECIALìì ì¹êµ¬ë¤ê³¼ì ì¦ê±°ì´ ê¸°ìµì ë§ëì¸ì</li>
                        <li>ìì½ : 2020-08-01 ~ 2020-12-31</li>
                        <li><span class="currency">KRW</span>&nbsp;<span class="cost"><b>550,000 ~</b></span></li>
                        <li><a href="#" class="promotion_more">more</a></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="facilities-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="facilities-item set-bg" data-setbg="img/reservation_top.jpg">
                            <div class="fi-title">
                            ...
                            <a href="#" class="primary-btn">Other Rooms</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="facilities-item set-bg fi-right" data-setbg="img/swimming.png">
                            <div class="fi-title">
                                <h2>:: ESPECIAL Facilities ::</h2>
                                <p> For all our guests and Bookers</p>
                            </div>
                            <a href="#" class="primary-btn">Make a Reservation</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="#" class="primary-btn">Other Facilities</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="facilities-item set-bg fi-right" data-setbg="img/wedding.png">
                            <div class="fi-title">
                                <h2>:: Wedding Hall ::</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="facilities-item set-bg fi-right" data-setbg="img/conference.png">
                            <div class="fi-title">
                    ...
                    <div class="col-lg-6">
                        <div class="rewards-text">
                            <div class="section-title">
                                <h2>Great Rewards<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;& Good Service</h2>
                            </div>
                            <p>
                                ì¸ê³ ìµê³ ì í¸íì¤ íëë¡ ì ì ë ESPECIALììë<br />Great Rewards & Good Service"ë¥¼ ëª¨í ë¡ <br />ë¤ìí ë¦¬ìë ííì
                                ëë¦¬ê³  ììµëë¤<br /> ESPECIALì ê°ì¡±ì´ ëì¤ ê³ ê°ëì ì§ì¬ì¼ë¡ ê¸°ë¤ë¦½ëë¤!
                            </p>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-item">
                            <div class="footer-logo">
                                <a href="mainpage.jsp"><img src="img/logo.png" alt="í¸í°ë¡ê³ "></a>
                            </div>
                            <p> ESPECIAL Hotel & Resort<br /> ëíì : ì´ì§ì<br /> ì¬ììë±ë¡ë²í¸ : 123-45-67890<br /> íµì íë§¤ì ì ê³ ë²í¸ :
                                1234-ìì¸ê°ë¨-1234
                                <br /> ê°ì¸ì ë³´ê´ë¦¬ì±ìì : ì´ì§ì<br />
                    ...
                    <div class="col-lg-4">
                        <div class="footer-item">
                            <h5>Contact Info</h5>
                            <ul>
                                <li><img src="img/placeholder.png" alt="ìì¹ ì´ë¯¸ì§" />110, Sejong Daero Jung-gu
                                    <br />Seoul,S.Korea<br /><br /> ìì¸í¹ë³ì ì¤êµ¬ ì¸ì¢ëë¡ 110(ííë¡1ê°)</li>
                                <li><img src="img/phone.png" alt="ì íê¸° ì´ë¯¸ì§" />+82(2)123-4567</li>
                                <li><img src="#" alt="facebook" /><img src="#" alt="instgram" /><img src="#"
                                        alt="line" /><img src="#" alt="youtube" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row pt-5">
                        <div class="col-lg-12">
                            <div class="small text-white text-center" id="copyright">
                                ...
                                Copyright &copy; Zia Lee. All rights reserved.
